...
app.post('/api/generate-poem', async (req, res) => {
    try {
        ...
        const systemRole = 'أنت شاعر عربي فصيح وخبير في العروض والقوافي. مهمتك إنشاء قصائد ملتزمة تماماً بالوزن والقافية والتشكيل. يجب عليك الالتزام الصارم بعدد الأبيات المطلوب.';
        
        const userPrompt = `اكتب قصيدة عربية من ${verses} أبيات بالضبط عن موضوع "${theme}"

⚠️ تنبيه مهم: عدد الأبيات المطلوب هو ${verses} أبيات فقط. لا أكثر ولا أقل.
...
1️⃣ اختر بحراً واحداً من [الطويل، الكامل، البسيط] يناسب الموضوع.

2️⃣ اكتب بالضبط ${verses} أبيات شعرية ملتزماً بـ:
   • التفعيلة المختارة بدقة
   • القافية الموحدة في كل الأبيات
   • التشكيل الكامل لكل كلمة
   • المعنى الواضح والجميل

3️⃣ ضع كل بيت في سطر منفصل.

🚫 ممنوع: أي شرح أو تحليل أو مقدمات أو تعليقات أو عناوين.
✅ المطلوب: ${verses} أبيات شعرية فقط.

تذكر: يجب أن يكون الناتج ${verses} أبيات بالضبط.`;
